...
export class ApiService {
  ...
  createWorkEntry(entry: any): Observable<ApiResponse<WorkEntry>> {
    ...
    const newEntry: WorkEntry = {
      ...
      plannedEffortHours: entry.plannedEffortHours != null ? Number(entry.plannedEffortHours) : (Number(entry.meetingEffortHours || 0) + Number(entry.workEffortHours || 0)),
      meetingEffortHours: entry.meetingEffortHours != null ? Number(entry.meetingEffortHours) : 0,
      workEffortHours: entry.workEffortHours != null ? Number(entry.workEffortHours) : 0,
      totalEffortHours: (entry.meetingEffortHours != null ? Number(entry.meetingEffortHours) : 0) + (entry.workEffortHours != null ? Number(entry.workEffortHours) : 0),
